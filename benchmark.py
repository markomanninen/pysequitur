...
def main():
    ...
    parser.add_argument("sequitur_version", choices=['Sequencer', 'Sequencer2', 'Sequencer3', 'Sequencer4'], help="Sequitur version to use.")
    ...
    elif args.sequitur_version == 'Sequencer4':
        sequitur_class = Sequencer4

    if sequitur_class is None:
        print(f"Error: Invalid Sequitur version specified: {args.sequitur_version}")
        return
